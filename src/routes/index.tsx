...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Subscribe to only the modules you need — speaking, writing, IELTS, business — taught in your native language." },
      { property: "og:title", content: "Lumen English — Modular AI English learning" },
      { property: "og:description", content: "An AI English platform built around the way you actually learn." },
    ],
  }),
  component: Landing,
});
      ...
      <section className="mx-auto max-w-6xl px-6 pt-10 pb-20 md:pt-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 text-lg text-muted-foreground">
            Pick only the modules you need. Speaking, writing, IELTS, business — each taught by a focused AI coach, in your native language.
          </p>
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-2 text-xs text-muted-foreground">
            ...
            {NATIVE_LANGUAGES.slice(0, 8).map((l) => (
              <span key={l.code} className="rounded-full bg-secondary px-2 py-0.5">{l.flag} {l.native}</span>
            ))}
